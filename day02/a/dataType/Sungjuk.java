...
public class Sungjuk {
	...
	String hakbun; // null 학번 981234	201234 
     ...
     */
		short total = (short)(kor + eng + math); // 형변환(casting) 0 ~ 300
	...
	static void char_print() {
		...
		// ...
		// Z 는 10진수로 90 로 보자. z 는 10진수로 122로 보자
		...
		char ch5 = 51456; // 준
		char ch6 = 54785; // 혁
		System.out.println(ch4+ch5+ch6); //158813
