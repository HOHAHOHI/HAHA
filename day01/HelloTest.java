/*
   ...
   ==== *** CLASS(클래스) 의 구조 **** ====
    ...
    4. 컴파일(compile)하기
       ...
       .class 파일은 기계(컴퓨터)가 알아 들을 수 있는 적브언어이며 실행되어지는 파일이다.                      
 */
...
// 기본적으로 import java.lang.*; 은 생략되어져 있다. => lang 패키지에 있는 모든 class는 모두 생략이 가능한 것인가? 
...
// 또한 저장시 파일명은 클래스명과 동일하게 해야 하며, 확장자는 .java이다.
// class body(클래스 본체)는 { 로 시작해서 }로 끝난다.
	...
	public static void main(String[] args) {
		...
		/**
		   문서화 주석
		   ==> 어떤 클래스나 어떤 메소드 생성시 javadoc 를 이용해서 API 문서를 만들 때 사용한다.
		 */
		
		// Systme.out 은 모니터 라고 보면 된다.
		/* Systme.out.print("출력하고자 하는 문자열") 은 
